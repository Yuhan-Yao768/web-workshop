...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    SendReplyMessage(variables: SendReplyMessageMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<SendReplyMessageMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<SendReplyMessageMutation>(SendReplyMessageDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'SendReplyMessage', 'mutation', variables);
    },
    GetRoomMessagesWithReplies(variables: GetRoomMessagesWithRepliesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetRoomMessagesWithRepliesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetRoomMessagesWithRepliesQuery>(GetRoomMessagesWithRepliesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetRoomMessagesWithReplies', 'query', variables);
    },
